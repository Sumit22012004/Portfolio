      ...
      <div className="container relative z-10 px-4 mx-auto max-w-6xl preserve-3d">
        <div className={`text-center space-y-8 transition-3d ${isVisible ? "opacity-100" : "opacity-0"}`} style={{ transform: isVisible ? "perspective(1000px) translateZ(0)" : "perspective(1000px) translateZ(-100px) rotateX(10deg)" }}>
          ...
          <div className="flex flex-wrap gap-4 justify-center items-center pt-8 animate-slide-up perspective-1000">
            <Button
              size="lg"
              className="min-w-[200px] bg-primary/10 border-2 border-primary/50 hover:bg-primary/20 hover:border-primary text-primary px-8 py-6 text-lg font-semibold rounded-xl transition-3d hover-3d-lift"
            ...
            <Button
              size="lg"
              variant="outline"
              className="min-w-[200px] bg-secondary/10 border-2 border-secondary/50 hover:bg-secondary/20 hover:border-secondary text-secondary hover:text-secondary px-8 py-6 text-lg font-semibold rounded-xl transition-3d hover-3d-lift"
