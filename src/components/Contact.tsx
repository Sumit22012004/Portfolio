    ...
    <section id="contact" className="py-24 px-4 bg-muted/20 relative overflow-hidden perspective-1200">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <SectionHeader
          ...
          subtitle={
            <>
              Building scalable AI systems and open to impactful GenAI roles.
              <br />
              <span className="font-medium text-foreground/80 block mt-1">Available for full-time AI Engineer roles | Remote & On-site</span>
            </>
          }
        />
        ...
        <div
          ref={sectionRef}
          className={`transition-3d-smooth ${isVisible
            ? "opacity-100"
            : "opacity-0"
            }`}
          style={{
